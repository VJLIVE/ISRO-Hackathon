...
import ParticleBackground from '../components/ParticleBackground'; // optional, if you have particles


export default function Home() {
  return (
    <div className="relative text-white bg-black overflow-x-hidden starry-bg">
      <ParticleBackground />

      {/* Hero */}
      <section className="bg-gradient-to-b from-black via-slate-900 to-slate-950 py-24 px-6 text-center">
        <motion.h1
      ...
      {/* Features */}
      <FadeInSection>
        <section className="bg-gradient-to-b from-slate-950 to-slate-900 grid grid-cols-1 md:grid-cols-3 gap-6 px-6 md:px-20 py-24">
      ...
      {/* How it works */}
      <FadeInSection>
        <section className="bg-gradient-to-b from-slate-900 to-black px-6 md:px-32 py-24 text-center border-t border-slate-800">
      ...
      {/* Meet the Bot */}
      <FadeInSection>
        <section className="bg-gradient-to-b from-black via-slate-900 to-black px-6 md:px-32 py-24 text-center">
          <h2 className="text-3xl font-bold mb-6">🤖 Meet the Bot</h2>
          <p className="text-gray-400 mb-8 max-w-3xl mx-auto">
            This AI-powered bot understands the structure of the MOSDAC portal through advanced document analysis. It can answer questions like:
          </p>
      ...
      <FadeInSection>
        <section className="bg-gradient-to-b from-slate-950 to-black px-6 md:px-32 py-24 text-center border-t border-slate-800">
          <h2 className="text-3xl font-bold mb-10">📊 Key Datasets & Services</h2>
      ...
      {/* Tech Stack */}
      <FadeInSection>
        <section className="bg-gradient-to-b from-black to-slate-950 px-6 md:px-32 py-24 text-center">
      ...
      {/* Use Cases */}
      <FadeInSection>
        <section className="bg-gradient-to-b from-slate-950 to-black px-6 md:px-32 py-24">
      ...
      {/* Footer */}
      <footer className="text-center text-gray-500 py-6 text-sm border-t border-slate-800 bg-black">
